...
class ProcessExecutorTest {
    ...
    void shouldThrowIllegalArgumentExceptionOnEmptyCommand() {
        try (ProcessExecutor executor = new ProcessExecutor()) {
            assertNotNull(assertThrows(IllegalArgumentException.class, () -> executor.execute(null, null, null)));
            assertNotNull(assertThrows(IllegalArgumentException.class, () -> executor.execute(List.of(), null, null)));
            assertNotNull(assertThrows(IllegalArgumentException.class, () -> executor.execute(List.of(""), null, null)));
            assertNotNull(assertThrows(IllegalArgumentException.class, () -> executor.execute(List.of("   "), null, null)));
        }
    }
